...
{ 	
	...
	public FindLeadsPage enteEmail() {
		// TODO Auto-generated method stub
...
System.out.println("clickonFirstLeadLink"+this.leadID);
	...
	public FindLeadsPage enterFNameToSelectFirstLead() {
		// TODO Auto-generated method stub
		Set<String> allWindows = driver.getWindowHandles();
		allhandles = new ArrayList<String>(allWindows);
		driver.switchTo().window(allhandles.get(1));
		driver.findElement(By.xpath("//input[@name='firstName']")).sendKeys("c");
		return this;
	}
	public FindLeadsPage enterFNameToSelectSecondLead() {
		// TODO Auto-generated method stub
		Set<String> allWindows = driver.getWindowHandles();
		allhandles = new ArrayList<String>(allWindows);
		driver.switchTo().window(allhandles.get(1));
	...
	public FindLeadsPage enterLeadid() {
		// TODO Auto-generated method stub
		System.out.println("enterLeadid"+this.leadID);
